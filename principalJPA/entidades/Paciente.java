...
public class Paciente implements Serializable {
    ...
    @Column(name="Fecha Nacimiento", length = 12, nullable= false)
    private Date fechaNac;
    @Column(name = "Edad", length = 5, nullable = false)
        private int edad;
    @Column(name = "Obra Social", length = 20, nullable = false)
...
@ManyToMany
@JoinTable(name="Turno_Paciente",
        joinColumns=@JoinColumn(name="turno_id"),
 inverseJoinColumns=@JoinColumn(name="paciente_documento"))
